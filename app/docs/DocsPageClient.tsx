...
export default function DocsPageClient() {
  ...
  return (
    <div className="min-h-screen bg-[#030303] text-zinc-300 selection:bg-[#57e071]/30 selection:text-white pt-32 pb-24 md:pb-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 pt-4 md:pt-6 pb-12 relative z-10 w-full">
        ...
        <div className="flex flex-col lg:flex-row gap-12 relative items-start w-full">
          ...
          <main className="flex-1 min-w-0 space-y-24 pb-32 w-full max-w-full">
