...
export default function LoginPage() {
  ...
  return (
    <main
      ref={containerRef}
      // Alterado para overflow-y-auto no mobile para evitar que o conteúdo seja cortado em telas menores
    ...
    >
      {/* Ajustado padding lateral de px-10 para px-6 no mobile para melhor aproveitamento de tela */}
      <div className="max-w-7xl mx-auto px-6 lg:px-10 relative z-10 w-full">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12 lg:gap-8">
          ...
          <div
            ref={contentRef}
            // Alinhamento centralizado no mobile e à esquerda no desktop
          ...
          >
            ...
            >
              <div className="space-y-4 flex flex-col items-center lg:items-start">
                ...
                {/* Ajuste de tamanho de fonte responsivo para evitar quebra excessiva no mobile */}
              ...
              {/* Mantido o alinhamento text-left dentro do box de especificações para preservar a estética de terminal */}
